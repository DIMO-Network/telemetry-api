...
func (m *MockCHService) GetEvents(ctx context.Context, tokenID int, from, to time.Time) ([]*model.Event, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEvents", ctx, tokenID, from, to)
...
func (mr *MockCHServiceMockRecorder) GetEvents(ctx, tokenID, from, to any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEvents", reflect.TypeOf((*MockCHService)(nil).GetEvents), ctx, tokenID, from, to)
}
