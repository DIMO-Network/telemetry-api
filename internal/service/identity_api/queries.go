...
type aftermarketDeviceAftermarketDevice struct {
	...
	Vehicle *aftermarketDeviceAftermarketDeviceVehicle `json:"vehicle"`
}
...
// GetVehicle returns aftermarketDeviceAftermarketDevice.Vehicle, and is useful for accessing the field via an interface.
func (v *aftermarketDeviceAftermarketDevice) GetVehicle() *aftermarketDeviceAftermarketDeviceVehicle {
	return v.Vehicle
}
...
// aftermarketDeviceAftermarketDeviceVehicle includes the requested fields of the GraphQL type Vehicle.
type aftermarketDeviceAftermarketDeviceVehicle struct {
	// The ERC-721 token id for the vehicle.
	TokenId int `json:"tokenId"`
}

// GetTokenId returns aftermarketDeviceAftermarketDeviceVehicle.TokenId, and is useful for accessing the field via an interface.
func (v *aftermarketDeviceAftermarketDeviceVehicle) GetTokenId() int { return v.TokenId }
