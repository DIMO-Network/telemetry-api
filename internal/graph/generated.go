...
`, BuiltIn: false},
  ...
  vinVCLatest(
    ...
    """
    tokenId: Int!
  ): VINVC @requiresVehicleToken @requiresPrivileges(privileges: [VEHICLE_VIN_CREDENTIAL])
}
...
func (ec *executionContext) _Query_deviceActivity(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive2 := func(ctx context.Context) (interface{}, error) {
			privileges, err := ec.unmarshalNPrivilege2ᚕgithubᚗcomᚋDIMOᚑNetworkᚋtelemetryᚑapiᚋinternalᚋgraphᚋmodelᚐPrivilegeᚄ(ctx, "MANUFACTURER_DEVICE_LAST_SEEN")
			if err != nil {
				return nil, err
			}
