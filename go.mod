module github.com/DIMO-Network/telemetry-api
...
require (
	...
	github.com/DIMO-Network/attestation-api v0.1.15
	...
	github.com/DIMO-Network/fetch-api v0.1.0
	github.com/DIMO-Network/model-garage v1.0.4
