...
gql-model: ## Generate gqlgen data model.
	...
	@go tool codegen -generators=custom -custom.output-file=internal/graph/model/signalLatest_gen.go -custom.template-file=./internal/graph/model/signalLatest.tmpl -custom.format=true
